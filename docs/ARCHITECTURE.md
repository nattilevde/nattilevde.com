...
| `engine.js`      | Renderer, camera, third-person controller, input, collision, discovery triggers, weather timer, sitting, fast travel, and the canoe and scooter modes.                                                                                                   |
...
proximity, advances the weather, then calls `environment.update()` and
